...
_colcon_activate_sh_COLCON_VENV_PREFIX="/home/rosi2/Documents/bainian-workspace/ros-stuff/rmf2_ws/install/.uv_python_project_venv/.venv"
...
_colcon_prepend_unique_value PYTHONPATH "$COLCON_VENV_PREFIX/lib/python3.10/site-packages/"
...
deactivate_all() {
  ...
  _colcon_venv_delete_value PYTHONPATH "$COLCON_VENV_PREFIX/lib/python3.10/site-packages/"
