...
class VenvSubverbExtensionPoint:
    """
    The interface for venv subverb extensions.

    A venv subverb extension provides a subverb to the `venv` verb of
    ...
    """The version of the venv subverb extension interface."""
    EXTENSION_POINT_VERSION = '1.0'

    def add_arguments(self, *, parser):
        """
        Add command line arguments specific to the venv subverb.
    ...
    def main(self, *, context):
        """
        Execute the venv subverb extension logic.
