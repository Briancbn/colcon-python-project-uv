...
from colcon_python_project_uv.venv.api import export_uv_venv


class ExportVenvSubverb(VenvSubverbExtensionPoint):
    """Export venv dependencies."""
    ...
    def add_arguments(self, *, parser):  # noqa: D102
        ...
        parser.add_argument(
            ...
            help='The path for the output requirement lock file (default: requirements.txt)')
